...
class DataProvider: NSObject {
    ...
    private lazy var bgSession: URLSession = {
        let config = URLSessionConfiguration.background(withIdentifier: "adlet.zhan.Networking")
...
extension DataProvider: URLSessionDelegate, URLSessionDownloadDelegate {
